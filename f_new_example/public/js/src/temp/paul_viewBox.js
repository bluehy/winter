...
// 슬라이드가 늘어나면서 나타나게 만들기-------------------------------------------
   ...
   slideThis.css({'zIndex':liLen + 2, 'width':0, 'overflow':'hidden'});             // 선택된 슬라이드를 강제적으로 위쪽, 크기를 0으로,
      slideThis.show(function(){                                             // 일단 나타나게 한 후에,
         slideThis.stop().animate({'width':100 + '%'},1000, 'easeOutCubic' ,function(){     // 크기를 늘리면서 등장, 
